...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-04-2017 a las 01:24:47
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `nombre`, `first_name`, `last_name`, `company`, `phone`, `direccion`, `codigo_postal`, `genero`, `asistencia`) VALUES
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1492643916, 1, NULL, 'Admin', 'istrator', 'ADMIN', '0', NULL, NULL, NULL, NULL);

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2017 a las 16:34:32
...
(2, 'Postre', 'Pan de elote', 25, 'Elote, Huevo, Arina', '00:35:00');
...
INSERT INTO `reservacion` (`id`, `nombre`, `fecha`, `hora`, `num_persona`) VALUES
(1, 'Max', '2017-04-26', '10:11:00', 2),
(2, 'Angel', '2017-04-26', '05:25:00', 4);
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, 'XE8XQwdTxNNKwmA4jBUD5.', 1268889823, 1493302776, 1, 'Admin', 'istrator', 'ADMIN', '0', NULL, NULL, NULL, NULL),
(2, '::1', 'paco@gmail.com', '$2y$08$SQhvSq8iHkf101WAJeVGEuxf4Lt/IKE7edqqGAf/0eqXOPVQt9hLy', NULL, 'paco@gmail.com', NULL, NULL, NULL, NULL, 1493258579, 1493302800, 1, 'Paco', 'Galicia', 'Mr Chilon', '2281456786', NULL, NULL, NULL, NULL);

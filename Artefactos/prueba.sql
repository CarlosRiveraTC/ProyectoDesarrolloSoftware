...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2017 a las 15:43:29
...
INSERT INTO `orden` (`numero_orden`, `fecha`, `num_mesa`) VALUES
(1, '2017-05-10', 1),
(2, '2017-05-10', 1),
(3, '2017-05-10', 1);
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, 'XE8XQwdTxNNKwmA4jBUD5.', 1268889823, 1494505919, 1, 'Admin', 'istrator', 'ADMIN', '0', NULL, NULL, NULL, NULL),
(2, '::1', 'paco@gmail.com', '$2y$08$SQhvSq8iHkf101WAJeVGEuxf4Lt/IKE7edqqGAf/0eqXOPVQt9hLy', NULL, 'paco@gmail.com', NULL, NULL, NULL, NULL, 1493258579, 1494507875, 1, 'Paco', 'Galicia', 'Mr Chilon', '2281456786', NULL, NULL, NULL, NULL),
(3, '::1', 'tlapa@pollo.com', '$2y$08$xAVtzppBBDCvhAcsHe3uJ.lE1B7WyKSqXVPNiU/786AuHUiRwLtae', NULL, 'tlapa@pollo.com', NULL, NULL, NULL, NULL, 1494463558, 1494504286, 1, 'Luis', 'Tlapa', 'UV', '12345678', NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `orden`
  MODIFY `numero_orden` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `orden`
  ADD CONSTRAINT `fk_mesa` FOREIGN KEY (`num_mesa`) REFERENCES `mesa` (`numero`);

...
class Ion_auth
{
	...
	public function es_mesero($id=false)
	{
		$this->ion_auth_model->trigger_events('es_mesero');
		$grupo_meseros = $this->config->item('grupo_meseros','ion_auth');
		return $this->in_group($grupo_meseros, $id);
	}
	public function es_recepcionista($id=false)
	{
		$this->ion_auth_model->trigger_events('es_recepcionista');
		$grupo_recepcionista = $this->config->item('grupo_recepcionista','ion_auth');
		return $this->in_group($grupo_recepcionista, $id);
	}
	public function es_chef($id=false)
	{
		$this->ion_auth_model->trigger_events('es_chef');
		$grupo_chef = $this->config->item('grupo_chef','ion_auth');
		return $this->in_group($grupo_chef, $id);
	}
	public function es_cajero($id=false)
	{
		$this->ion_auth_model->trigger_events('es_cajero');
		$grupo_cajero = $this->config->item('grupo_cajero','ion_auth');
		return $this->in_group($grupo_cajero, $id);
	}
	public function es_usuario($id=false)
	{
		$this->ion_auth_model->trigger_events('es_usuario');
		$grupo_usuario = $this->config->item('default_group','ion_auth');
		return $this->in_group($grupo_usuario, $id);
	}
	/**
	 * in_group
	 *

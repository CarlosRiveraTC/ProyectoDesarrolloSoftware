...
$config['default_group']              = 'Usuario';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['grupo_meseros']							= 'Meseros';					 // Grupo de meseros login
$config['grupo_recepcionista']        = 'Recepcionista';     // Grupo de recepcionistas login
$config['grupo_chef']                 = 'Chef';              // Grupo de chefs login
$config['grupo_cajero']               = 'Cajero';            // Grupo de cajeros login

        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav">
            <li <?php if ($activa == '/') { echo "class='active'"; } ?>>
              <a href="<?=base_url()?>cajero"><span class="glyphicon glyphicon-briefcase"></span>&nbsp;Caja</a>
            </li>
            <li>
              <a href="<?=base_url()?>cajero/buscarFactura"><span class="glyphicon glyphicon-th-large"></span>&nbsp;Facturas</a>
            </li>
            <li>

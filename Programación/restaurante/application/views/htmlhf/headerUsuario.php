        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav">
            <li <?php if ($activa == '/') { echo "class='active'"; } ?>>
              <a href="<?=base_url()?>usuario/vista"><span class="glyphicon glyphicon-home"></span>&nbsp;Inicio</a>
            </li>
            <li <?php if ($activa == 'agregar') { echo "class='active'"; } ?>>
              <a href="<?=base_url()?>usuario/reservacion"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Reservacion</a>
            </li>
            <li>

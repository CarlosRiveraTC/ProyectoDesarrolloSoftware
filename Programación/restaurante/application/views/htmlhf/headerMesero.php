        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav">
            <li <?php if ($activa == '/') { echo "class='active'"; } ?>>
              <a href="<?=base_url()?>mesero/"><span class="glyphicon glyphicon-home"></span>&nbsp;Inicio</a>
            </li>
            <li <?php if ($activa == 'ordenes') { echo "class='active'"; } ?>>
              <a href="<?=base_url()?>mesero/ordenes"><span class="glyphicon glyphicon-list-alt"></span>&nbsp;Ordenes</a>
            </li>
            <li>

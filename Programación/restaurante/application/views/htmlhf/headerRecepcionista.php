        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav">
            <li <?php if ($activa == '/') { echo "class='active'"; } ?>>
              <a href="<?=base_url()?>recepcionista"><span class="glyphicon glyphicon-home"></span>&nbsp;Inicio</a>
            </li>
            <li <?php if ($activa == 'agregar') { echo "class='active'"; } ?>>
              <a href="<?=base_url()?>recepcionista/buscar"><span class="glyphicon glyphicon-search"></span>&nbsp;Buscar</a>
            </li>
            <li>
              <a href="<?=base_url()?>recepcionista/reservar"><span class="glyphicon glyphicon-th-large"></span>&nbsp;Reservacion</a>
            </li>
            <li>

...
<div class="jumbotron">
  ...
  <a href="<?=base_url()?>alma/MostrarCereales"><h4>Cereales</h4></a></li>
        ...
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-4 control-label">Tipo de producto</label>

          <input type="radio" id=tipo name="tipo" value="Carnes" required=""/>Carnes
          <input type="radio" id=tipo name="tipo" value="Frutas" required=""/>Frutas
          <input type="radio" id=tipo name="tipo" value="Verduras" required=""/>Verduras
          <input type="radio" id=tipo name="tipo" value="Semillas" required=""/>Semillas
          <input type="radio" id=tipo name="tipo" value="Enlatados" required=""/>Enlatados
          <input type="radio" id=tipo name="tipo" value="Pastas" required=""/>Pastas
          <input type="radio" id=tipo name="tipo" value="Cereales" required=""/>Cereales
            </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre Producto" required="">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="num_pieza" name="num_pieza" placeholder="Cantidad" required="">
            <label for="inputEmail3" class="col-sm-4 control-label">Unidades: </label>
            <input type="radio" id=unidad name="unidad" value="Kilos" required=""/>Kilos
          <input type="radio" id=unidad name="unidad" value="Piezas" required=""/>Piezas
          <input type="radio" id=unidad name="unidad" value="Gramos" required=""/>Gramos
